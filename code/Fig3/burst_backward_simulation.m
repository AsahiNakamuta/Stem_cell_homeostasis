...
for i_ep = 1:3
    ...
    for i_height = 1:n_openniche/10
        ...
        for l = 1:m
            %initial condition
            x_matrix(1,1) = height;
            x_matrix(2,1) = n_openniche - height;
            %time evolution
            i = 1;
            while  x_matrix(1,i) ~= 0
...
save(['simu_backward_burstprob',filename],'burstprob')
save(['simu_backward_duration',filename],'duration')
save('variables.mat')
